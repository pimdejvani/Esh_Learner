...
/// closest known related word → first letter → first & last letter, and no
/// further. The Thai translation step is skipped here (user request
/// 2026-07-24) — dictation tests spelling from sound, so handing over the
/// meaning is the wrong kind of help. Using any step caps the rating at
/// Hard via `answer_checker.capForHint`.
library;
