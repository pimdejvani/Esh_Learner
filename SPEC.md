...
- **"You Pass"** (เพิ่ม 2026-07-23) — เมื่อ**ทุกคำถูกตอบถูกอย่างน้อย 1 ครั้งในทุกเกม** (rating ≠ Again, เช็คจาก `reviews_log` ผ่าน `domain/mastery.dart`) แอปขึ้นหน้าจอฉลองเต็มจอ "You Pass" **ครั้งเดียว** (จำผ่าน setting `you_pass_shown`) แล้วกด "เล่นต่อ" กลับมาเล่นได้ตามปกติ
