...
# New words as cues get their own top-6 in-vocab rows; existing A1 cues
# additionally gain up to 2 strongest NEW-word responses (their original
# 153-vocab top-6 snapshot above is left untouched).
try:
    from ext_a2b1 import SWOW_EXT
    for _cue, _rows in SWOW_EXT.items():
        SWOW_ASSOCIATIONS[_cue] = SWOW_ASSOCIATIONS.get(_cue, []) + _rows
except ImportError:
    pass
